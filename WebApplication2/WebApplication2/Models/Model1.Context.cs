...
namespace WebApplication2.Models
{
    ...
    public partial class testEntities : DbContext
    {
        ...
        public virtual ObjectResult<Route> test()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Route>("test");
        }
    
        public virtual ObjectResult<Route> test(MergeOption mergeOption)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Route>("test", mergeOption);
        }
    }
}
